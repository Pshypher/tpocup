...
def multi_find(some_string, substring, start=0, end=None):
    """Returns a list containing all the indices of all the occurences of
        a substring within a larger string. An empty list is returned if the
