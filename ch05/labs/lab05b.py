...
for line in input_file:
    ...
    if line_count == 1:
        print("{:<12s}{:<12s}{:<12s}{:<12s}".format("Name", "Height(m)",
                                        "Weight(kg)", "BMI"), file=output_file)
        continue
    ...
    print("{:<12s}{:<12.2f}{:<12.2f}{:<12.2f}".format(line[:12], height_flt,
                                        weight_flt, bmi_flt), file=output_file)
...
print(avg_line, file=output_file)
print(max_line, file=output_file)
print(min_line, file=output_file)
