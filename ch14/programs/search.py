# -*- coding: utf-8 -*-
"""
Created on Tue Sep  4 12:38:22 2018
...
print('Found {} directories containing files with ".txt" suffix and target \
string: {}'.format(len(dir_list), search_str))
print('Found {} files with ".txt" suffix files containing the target string: \
