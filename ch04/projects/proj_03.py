...
# If the user enters a word other than the string corresponding to "."
    # If the first character of the string is a vowel, append "yay" to the end
    # of the word
...
# Halt the program if a period "." is entered by the user
